...
import org.neo4j.cypher.internal.v3_5.ast.semantics.{SemanticAnalysisTooling, SemanticCheckable, SemanticExpressionCheck, _}
import org.neo4j.cypher.internal.v3_5.expressions.{Expression, LabelName, LogicalProperty, Variable}
